...
- **Treni in tempo reale** — dati di **ViaggiaTreno** (marchio registrato di **Trenitalia S.p.A.**). Secondo i [Termini e condizioni di ViaggiaTreno](https://www.viaggiatreno.it/), i contenuti sono protetti da copyright e **non possono essere copiati, riprodotti, trasferiti, pubblicati o distribuiti senza il consenso scritto di Trenitalia S.p.A.**; è consentito il solo **utilizzo personale a carattere informativo**. I dati sono forniti "a scopo esclusivamente informativo" e possono non coincidere con quelli certificati dal Gestore dell'Infrastruttura (per gli indennizzi da ritardo valgono questi ultimi). Trenitalia declina ogni responsabilità per errori od omissioni. Il server incluso inoltra le API per la **sola consultazione personale**, senza memorizzare i dati.
...
- **🚆 Dati ViaggiaTreno — NON ridistribuibili.** I [Termini e condizioni di ViaggiaTreno](https://www.viaggiatreno.it/) consentono il **solo utilizzo personale a carattere informativo** e **vietano espressamente** di copiare, riprodurre, trasferire, pubblicare o distribuire i contenuti senza il consenso scritto di Trenitalia S.p.A.; "ViaggiaTreno" è inoltre un marchio registrato e il deep linking è vietato. Di conseguenza **un'istanza pubblica che mostra i dati dei treni ad altri utenti non è conforme a quei termini.** Per un deploy pubblico hai due strade: ottenere un'**autorizzazione scritta** da Trenitalia, oppure **rimuovere/disattivare la funzione treni** dall'istanza pubblica. L'uso personale e self-hosted (solo per te) rientra invece nell'utilizzo informativo consentito. Questo progetto **non** è affiliato, sponsorizzato o approvato da Trenitalia / Gruppo FS Italiane.
